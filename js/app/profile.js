...
export async function render(el){
  ...
  async function tab(key){
    ...
    await region(box,async()=>key,(k,target)=>({
      history,security,race,exam,subscriptions
    }
    [k])(target));
  }
