...
const pages={'hotel-owner':()=>import('./hotel-owner.js'),home:()=>import('./home.js'),hotel:()=>import('./hotel.js'),profile:()=>import('./profile.js'),dm:()=>import('./social.js'),notifications:()=>import('./social.js'),leaderboard:()=>import('./social.js'),admin:()=>import('./admin.js')};
shell();
