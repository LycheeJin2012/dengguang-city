...
export async function render(el){
  ...
  region($('#gallery-body',el),()=>api('/api/gallery'),(d,box)=>mountCarousel(box,d.items||[],{imageUrl,onOpen:g=>modal(g.title,`<img class="gallery-original wide" src="${esc(imageUrl(g.image_url))}" alt="${esc(g.title)}">`,{wide:true})}));
