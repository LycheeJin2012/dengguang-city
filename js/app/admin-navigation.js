...
const superOnly = new Set(['tracks', 'hotels', 'rooms', 'requirements', 'announcements', 'gallery', 'admins', 'dms', 'owners', 'audit', 'knowledge']);
export const groups = [
  { id: 'tickets', label: ['🎫 工单中心', '🎫 Tickets'], children: ['tickets'] },
  { id: 'dispatch', label: ['📋 派单', '📋 Dispatch'], children: ['dispatch'] },
  { id: 'support', label: ['🎧 人工客服', '🎧 Human support'], children: ['support'] },
  ...
  { id: 'knowledge', label: ['📚 知识库', '📚 Knowledge base'], children: ['knowledge'] },
