...
const DICT = {
  ...
  'admin.passkey.offer.title':   { 'zh-CN': '添加通行密钥 (推荐)', 'en': 'Add a Passkey (Recommended)' },
  'admin.passkey.offer.desc':    { 'zh-CN': '通行密钥 (Passkey) 用 Touch ID / Face ID / Windows Hello 登录，<b>无需输密码</b>，抗钓鱼。', 'en': 'Passkey uses Touch ID / Face ID / Windows Hello — <b>no password needed</b>, phishing-resistant.' },
  'admin.passkey.offer.sub':     { 'zh-CN': '下次登录直接指纹, 不再忘记密码。', 'en': 'Sign in with fingerprint next time, no more forgotten passwords.' },
  'admin.passkey.offer.dismiss': { 'zh-CN': '7 天内不再提示',     'en': 'Don\'t show for 7 days' },
  'admin.passkey.offer.addNow':  { 'zh-CN': '立即添加',           'en': 'Add Now' },
  ...
  'admin.login.err.empty':    { 'zh-CN': '请输入账号和密码',         'en': 'Please enter username and password' },
  'admin.login.err.fail':     { 'zh-CN': '登录失败',                'en': 'Login failed' },
  'admin.login.err.isPlayer': { 'zh-CN': '这是玩家账号',             'en': 'This is a player account' },
  'admin.login.err.failPrefix':{ 'zh-CN': '登录失败: ',              'en': 'Login failed: ' },
  'admin.enterModal.title':     { 'zh-CN': '进入管理后台',           'en': 'Enter Admin Console' },
  'admin.enterModal.bound':     { 'zh-CN': '玩家',                   'en': 'Player' },
  'admin.enterModal.bound2':    { 'zh-CN': '已绑管理员',             'en': 'is bound to admin' },
  'admin.enterModal.hint':      { 'zh-CN': '选择以下任一方式验证身份进入后台:', 'en': 'Choose any method below to verify your identity:' },
  'admin.enterModal.pwLabel':   { 'zh-CN': '管理员密码',             'en': 'Admin Password' },
  'admin.enterModal.pwPh':      { 'zh-CN': '输入管理员密码',          'en': 'Enter admin password' },
  'admin.enterModal.submit':    { 'zh-CN': '验证进入',                'en': 'Verify & Enter' },
  'admin.enterModal.or':        { 'zh-CN': '或',                      'en': 'or' },
  'admin.enterModal.passkeyBtn':{ 'zh-CN': '用通行密钥登录 (Touch ID / Face ID)', 'en': 'Sign in with Passkey (Touch ID / Face ID)' },
  'admin.enterModal.passkeyTip':{ 'zh-CN': '通行密钥登录需在主页先注册一次 (Touch ID/Face ID), 然后 admin 绑玩家 → 一键登 admin', 'en': 'Register a passkey on the main site first, then link to admin — one-click login.' },
  'admin.enterModal.verifying': { 'zh-CN': '⏳ 验证中...',             'en': '⏳ Verifying...' },
  'admin.enterModal.success':   { 'zh-CN': '✓ 验证成功, 跳转中...',   'en': '✓ Verified, redirecting...' },
  'admin.enterModal.badPw':     { 'zh-CN': '密码错误',                'en': 'Wrong password' },
  'passkey.err.challengeFail':  { 'zh-CN': 'challenge 失败',          'en': 'challenge failed' },
  'passkey.err.noChallenge':    { 'zh-CN': '服务器未返回 challenge',  'en': 'Server did not return challenge' },
