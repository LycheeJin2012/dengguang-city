...
// v40.5: SCHEMA + MIGRATIONS 拆到 _schema.js, dynamic import 减少 init.js 加载负担
...
export async function onRequestGet(context) {
  ...
  // v40.5: dynamic import SCHEMA 数组 (只在这个 fallback 端点用到, GET 大部分路径不需要)
...
请写一段 100 字以内的回复草稿：`;
  ...
  // 1. 建表 (v40.5: SCHEMA + MIGRATIONS 拆到 _schema.js, dynamic import)
